        ...
        <div className="prose prose-sm max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              Hirrd ("we", "us", "our") operates the Hirrd website and mobile
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Hirrd uses the collected data for various purposes including
              providing and maintaining our Service, notifying you about changes
              to our Service, and detecting and preventing fraudulent
              transactions.
            </p>
          </section>
