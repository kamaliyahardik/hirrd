  ...
  return (
    <>
      <section className="pb-32 md:pb-44 bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat text-slate-800 text-sm">
        {/* HERO */}
        <div className="flex flex-col-reverse gap-10 md:flex-row px-4 md:px-16 lg:px-24 xl:px-32 mt-22 md:mt-32 md:ml-15">
          {/* LEFT CONTENT */}
          <div className="max-md:text-center">
            ...
            <p className="text-sm md:text-base max-w-lg mt-6 text-slate-600">
              Join a trusted job platform connecting skilled professionals with
              verified companies worldwide.
            </p>
            ...
            <div className="flex items-center max-md:justify-center">
              ...
              <div>
                <p className="text-sm text-slate-500">
                  Trusted by 10+ job seekers & recruiters
                </p>
              </div>
            </div>
          </div>
