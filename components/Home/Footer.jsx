          ...
          <div className="flex flex-col md:flex-row items-start justify-between relative p-8 md:p-12 overflow-hidden pb-32 md:pb-42 rounded-t-2xl">
            ...
            <AnimatedContent distance={40} className="max-w-72">
              <Image
                ...
                className="h-9"
              />
              <p className="text-black mt-4 pb-6">
            ...
            <div>
              ...
              <AnimatedContent className="flex flex-col mt-6 gap-3">
                <a
                  href="https://x.com/hardik_kamliyaa"
                ...
                <a
                  href="https://www.linkedin.com/in/hardik-kamaliya/"
                  className="flex items-center gap-2 text-black"
                >
                ...
                <a
                  href="https://www.instagram.com/hardik.kamaliya_"
                  className="flex items-center gap-2 text-black"
                >
                ...
                <a
                  href="https://github.com/kamaliyahardik/hirrd"
                  className="flex items-center gap-2 text-black"
                  target="_blank"
                >
                  <Github size={20} />
                ...
                <a
                  href="mailto:hirrd.careers@gmail.com"
                  className="flex items-center gap-2 text-black"
                >
                  ...
                  <span className="flex items-center gap-2">
                    Careers
                    <span className="text-[10px] font-medium text-white bg-black rounded-md px-2 py-0.5">
                      We’re hiring!
                    </span>
                  </span>
                </a>
